			...
			>
				<div className=" max-w-[1200px] min-w-[1200px] flex items-center relative  h-[80px] my-0 mx-auto">
					<div className="flex h-5 items-center">
						...
						<Link
							to="/"
							className=" block  mr-[16px] ease-linear transform hover:scale-110 transition duration-500 "
						>
							<img
								className="transform h-[100%] w-[170px]"
								src={process.env.PUBLIC_URL + "/zwiggy.svg"}
							/>
						</Link>
					</div>
					...
					{showSearchbar ? (
						<>
							<ul
								className=" flex-1 min-w-0 flex flex-row justify-end items-center "
								id="searchBar"
							>
								<li className="relative">
									<input
										type="text"
										className="p-2 text-[1.1rem] leading-[24px] w-[600px] h-[48px] align-middle text-[500] border-solid border-[1px] border-[#282c3f33]"
					...
					>
						<li className="group mr-[80px] text-[#3d4152] text-[6px] font-[500]">
							<a
							...
							>
								<span className="absolute top-[50%] left-0 -translate-y-[50%] text-xl ">
									<svg
										className="group-hover:fill-[#fc8019]"
										viewBox="5 -1 12 25"
										height="17"
										width="17"
										fill="#686b78"
						...
						<li className="group mr-[80px] text-[#3d4152] text-[6px] font-[500]">
							...
							>
								...
								<span className="text-[16px] ">Offers</span>
							</a>
						</li>
						<li className="group mr-[80px] text-[#3d4152] text-[6px] font-[500]">
							<a
						...
						<li className="group  text-[#3d4152] text-[6px] font-[500]">
							<a
								className="relative flex h-[80px] cursor-pointer pl-[28px] items-center ml-[-28px] group-hover:text-[#fc8019]"
								href="/"
							>
